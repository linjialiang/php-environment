...
-   `2026.02.10` : 重构文档，移除了旧版内容，旧版请自行去阅读源码的 `v1` 分支；
-   `2025/12/13` : 正式移除 `php 8.4` 支持，由 `php 8.5` 取代；
-   `2025/01/22` : 正式移除 `php 8.3` 支持，由 `php 8.4` 取代，其相关内容请阅读；
-   `2025/09/09` : 正式移除 `php 7.4` 支持，因 `debian13` 编译安装该版本需要解决非常多的兼容性问题，其相关内容请阅读；
