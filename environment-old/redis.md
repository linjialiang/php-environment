...
::: details 基础配置
::: code-group
<<< @/assets/environment-old/source/redis/redis.conf{ini} [主配置]
<<< @/assets/environment-old/source/etc/redis/config/source.conf{ini} [原始配置]
:::

::: details 自定义配置
::: code-group
<<< @/assets/environment-old/source/etc/redis/config/custom/01-network.conf{ini} [01-network.conf]
<<< @/assets/environment-old/source/etc/redis/config/custom/02-tls.conf{ini} [02-tls.conf]
<<< @/assets/environment-old/source/etc/redis/config/custom/03-general.conf{ini} [03-general]
<<< @/assets/environment-old/source/etc/redis/config/custom/04-rdb.conf{ini} [04-rdb]
<<< @/assets/environment-old/source/etc/redis/config/custom/05-replication.conf{ini} [05-replication]
<<< @/assets/environment-old/source/etc/redis/config/custom/06-keys-tracking.conf{ini} [06-keys-tracking]
<<< @/assets/environment-old/source/etc/redis/config/custom/07-acl.conf{ini} [07-acl]
<<< @/assets/environment-old/source/etc/redis/config/custom/08-client.conf{ini} [08-client]
<<< @/assets/environment-old/source/etc/redis/config/custom/09-memory-management.conf{ini} [09-memory-management]
<<< @/assets/environment-old/source/etc/redis/config/custom/10-lazy-freeing.conf{ini} [10-lazy-freeing]
<<< @/assets/environment-old/source/etc/redis/config/custom/11-io.conf{ini} [11-io]
<<< @/assets/environment-old/source/etc/redis/config/custom/12-oom.conf{ini} [12-oom]
<<< @/assets/environment-old/source/etc/redis/config/custom/13-thp.conf{ini} [13-thp]
<<< @/assets/environment-old/source/etc/redis/config/custom/14-aof.conf{ini} [14-aof]
<<< @/assets/environment-old/source/etc/redis/config/custom/15-shutdown.conf{ini} [15-shutdown]
<<< @/assets/environment-old/source/etc/redis/config/custom/16-long-blocking.conf{ini} [16-long-blocking]
<<< @/assets/environment-old/source/etc/redis/config/custom/17-long-cluster.conf{ini} [17-long-cluster]
<<< @/assets/environment-old/source/etc/redis/config/custom/18-long-cluster-support.conf{ini} [18-long-cluster-support]
<<< @/assets/environment-old/source/etc/redis/config/custom/19-slow-log.conf{ini} [19-slow-log]
<<< @/assets/environment-old/source/etc/redis/config/custom/20-latency.conf{ini} [20-latency]
<<< @/assets/environment-old/source/etc/redis/config/custom/21-event-notification.conf{ini} [21-event-notification]
<<< @/assets/environment-old/source/etc/redis/config/custom/22-advanced-config.conf{ini} [22-advanced-config]
<<< @/assets/environment-old/source/etc/redis/config/custom/23-active-defragmentation.conf{ini} [23-active-defragmentation]
:::

::: details 日志分割
使用 Logrotate 自动轮转来分割日志

<<< @/assets/environment-old/source/logrotate.d/redis{bash}
...
<<< @/assets/environment-old/source/service/redis.service{ini} [系统单元配置]
...
::: code-group
<<< @/assets/environment-old/source/redis/gen-test-certs.sh [脚本]
