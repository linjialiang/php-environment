...
::: details 构建选项预览
::: code-group
<<<@/assets/environment-new/source/php/configure/74.ini [7.4]
<<<@/assets/environment-new/source/php/configure/83.ini [8.3]
:::
...
::: details 构建指令参考
::: code-group
<<<@/assets/environment-new/source/php/build/83.bash [8.3]
<<<@/assets/environment-new/source/php/build/74.bash [7.4]
:::
...
::: details php 主配置文件案例
::: code-group
<<<@/assets/environment-new/source/php/83/php-fpm.conf{ini} [8.3]
...
::: details 通用工作池案例
::: code-group
<<<@/assets/environment-new/source/php/83/php-fpm.d/default.conf{ini} [8.3]
<<<@/assets/environment-new/source/php/74/php-fpm.d/default.conf{ini} [7.4]
:::

::: details ThinkPHP 项目专用工作池案例
<<<@/assets/environment-new/source/php/83/php-fpm.d/tp.conf{ini}
:::
...
::: code-group
<<<@/assets/environment-new/source/service/php/source/83/php-fpm.service{ini} [php8.3]
...
::: code-group
<<<@/assets/environment-new/source/service/php/php83-fpm.service{bash} [php8.3]
...
1. details 新建配置文件
    ...
    ::: details 配置文件内容
    <<<@/assets/environment-new/source/php/config.inc.php
    :::
