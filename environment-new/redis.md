...
::: details 基础配置
::: code-group
<<<@/assets/environment-new/source/redis/redis.conf{ini} [主配置]
<<<@/assets/environment-new/source/etc/redis/config/source.conf{ini} [原始配置]
:::

::: details 自定义配置
::: code-group
<<<@/assets/environment-new/source/etc/redis/config/custom/01-network.conf{ini} [01-network.conf]
<<<@/assets/environment-new/source/etc/redis/config/custom/02-tls.conf{ini} [02-tls.conf]
<<<@/assets/environment-new/source/etc/redis/config/custom/03-general.conf{ini} [03-general]
<<<@/assets/environment-new/source/etc/redis/config/custom/04-rdb.conf{ini} [04-rdb]
<<<@/assets/environment-new/source/etc/redis/config/custom/05-replication.conf{ini} [05-replication]
<<<@/assets/environment-new/source/etc/redis/config/custom/06-keys-tracking.conf{ini} [06-keys-tracking]
<<<@/assets/environment-new/source/etc/redis/config/custom/07-acl.conf{ini} [07-acl]
<<<@/assets/environment-new/source/etc/redis/config/custom/08-client.conf{ini} [08-client]
<<<@/assets/environment-new/source/etc/redis/config/custom/09-memory-management.conf{ini} [09-memory-management]
<<<@/assets/environment-new/source/etc/redis/config/custom/10-lazy-freeing.conf{ini} [10-lazy-freeing]
<<<@/assets/environment-new/source/etc/redis/config/custom/11-io.conf{ini} [11-io]
<<<@/assets/environment-new/source/etc/redis/config/custom/12-oom.conf{ini} [12-oom]
<<<@/assets/environment-new/source/etc/redis/config/custom/13-thp.conf{ini} [13-thp]
<<<@/assets/environment-new/source/etc/redis/config/custom/14-aof.conf{ini} [14-aof]
<<<@/assets/environment-new/source/etc/redis/config/custom/15-shutdown.conf{ini} [15-shutdown]
<<<@/assets/environment-new/source/etc/redis/config/custom/16-long-blocking.conf{ini} [16-long-blocking]
<<<@/assets/environment-new/source/etc/redis/config/custom/17-long-cluster.conf{ini} [17-long-cluster]
<<<@/assets/environment-new/source/etc/redis/config/custom/18-long-cluster-support.conf{ini} [18-long-cluster-support]
<<<@/assets/environment-new/source/etc/redis/config/custom/19-slow-log.conf{ini} [19-slow-log]
<<<@/assets/environment-new/source/etc/redis/config/custom/20-latency.conf{ini} [20-latency]
<<<@/assets/environment-new/source/etc/redis/config/custom/21-event-notification.conf{ini} [21-event-notification]
<<<@/assets/environment-new/source/etc/redis/config/custom/22-advanced-config.conf{ini} [22-advanced-config]
<<<@/assets/environment-new/source/etc/redis/config/custom/23-active-defragmentation.conf{ini} [23-active-defragmentation]
:::

::: details 日志分割
使用 Logrotate 自动轮转来分割日志

<<<@/assets/environment-new/source/logrotate.d/redis{bash}
