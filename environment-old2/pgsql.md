...
<<< @/assets/environment-old2/source/service/postgres.service{bash} [unit]
...
::: code-group
<<< @/assets/environment-old2/source/postgres/postgresql.conf{ini} [服务端配置文件]
<<< @/assets/environment-old2/source/postgres/pg_hba.conf{ini} [客户访问限制配置文件]
:::
...
<<< @/assets/environment-old2/source/postgres/gen-test-certs.sh [一键脚本]
