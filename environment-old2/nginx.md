...
<<< @/assets/environment-old2/source/nginx/build_now.bash [构建选项]
...
<<< @/assets/environment-old2/source/nginx/build_all.bash [全部构建选项]
...
<<< @/assets/environment-old2/source/nginx/help.ini [全部参数]
...
::: code-group
<<< @/assets/environment-old2/source/nginx/nginx.conf{nginx} [配置文件]
<<< @/assets/environment-old2/source/etc/example/nginx/main.nginx{nginx} [主配置]
<<< @/assets/environment-old2/source/etc/example/nginx/custom/default.nginx [默认站点]
<<< @/assets/environment-old2/source/etc/example/nginx/custom/php_forward{nginx} [php 文件转发]
:::
...
::: code-group
<<< @/assets/environment-old2/source/etc/example/nginx/custom/cache{nginx} [统一缓存模板案例]
<<< @/assets/environment-old2/source/etc/example/nginx/custom/no_cache{nginx} [禁用缓存模板案例]
:::
...
<<< @/assets/environment-old2/source/etc/example/nginx/custom/gzip{nginx}
...
::: code-group
<<< @/assets/environment-old2/source/etc/example/nginx/custom/limit_req_http{nginx} [http 区块]
<<< @/assets/environment-old2/source/etc/example/nginx/custom/limit_req_server{nginx} [server 区块]
...
<<< @/assets/environment-old2/source/etc/example/nginx/custom/no_access{nginx}

### 7. 跨域请求

`nginx server` 可以配置跨域请求，跨域请求没有单独文件，按需写入对应站点的 `location 区块`

<<< @/assets/environment-old2/source/etc/example/nginx/custom/cross_domain{nginx}

### 8. 站点配置案例

::: code-group
<<< @/assets/environment-old2/source/nginx/sites/example.nginx [配置说明]
<<< @/assets/environment-old2/source/nginx/sites/static.nginx [静态站点]
<<< @/assets/environment-old2/source/nginx/sites/tp.nginx [tp 站点]
<<< @/assets/environment-old2/source/nginx/sites/laravel.nginx [laravel 站点]
<<< @/assets/environment-old2/source/nginx/sites/webdav.nginx [webdav 站点]
:::
...
<<< @/assets/environment-old2/source/service/nginx.service{ini} [案例]
...
<<< @/assets/environment-old2/source/nginx/nginxctl.bash [源码]
<<< @/assets/environment-old2/source/nginx/nginxctl-echo.bash [源码直写版]
