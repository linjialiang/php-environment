...
::: code-group
<<< @/assets/environment-lnmpp/source/php/build/84.bash [84]
...
<<< @/assets/environment-lnmpp/source/php/configure/84.ini [8.4 选项]
:::
...
::: details php 主配置文件案例
::: code-group
<<< @/assets/environment-lnmpp/source/php/84/php-fpm.conf{ini} [8.4]
:::
...
::: code-group
<<< @/assets/environment-lnmpp/source/php/84/php-fpm.d/default.conf{ini} [84-default]
<<< @/assets/environment-lnmpp/source/php/84/php-fpm.d/tp.conf{ini} [tp]
<<< @/assets/environment-lnmpp/source/php/84/php-fpm.d/example/default.conf{ini} [案例说明]
:::
...
::: code-group
<<< @/assets/environment-lnmpp/source/service/php/php84-fpm.service{bash} [84]
...
<<< @/assets/environment-lnmpp/source/service/php/source/84/php-fpm.service{ini} [84 默认]
