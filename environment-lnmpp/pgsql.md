...
flex libreadline-dev zlib1g-dev libpam0g-dev libxslt1-dev libxslt1-dev \
...
<<< @/assets/environment-lnmpp/source/service/postgres.service{bash} [unit]
...
::: code-group
<<< @/assets/environment-lnmpp/source/postgres/postgresql.conf{ini} [服务端配置文件]
<<< @/assets/environment-lnmpp/source/postgres/pg_hba.conf{ini} [客户访问限制配置文件]
:::
...
<<< @/assets/environment-lnmpp/source/postgres/gen-test-certs.sh [一键脚本]
