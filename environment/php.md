...
-   从 2025/01/22 开始正式移除 `php-8.3.x` 版本的相关文档说明；
...
```bash [84]
mkdir /home/php-fpm/php-8.4.2/build_php
cd /home/php-fpm/php-8.4.2/build_php/
```
...
```bash [84]
cp /home/php-fpm/php-8.4.2/php.ini-* /server/php/84/lib/
# 开发环境
