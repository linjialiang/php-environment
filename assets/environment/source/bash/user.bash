...
-g nginx -u 2001 -s /sbin/nologin -m nginx
...
-g postgres -u 2002 -s /sbin/nologin -m postgres
...
-g php-fpm -u 2003 -s /sbin/nologin -m php-fpm
...
-g redis -u 2005 -s /sbin/nologin -m redis
...
-g mysql -u 2006 -s /sbin/nologin -m mysql
...
-g sqlite -u 2007 -s /sbin/nologin -m sqlite
